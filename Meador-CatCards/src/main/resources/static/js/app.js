...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('next_cat').addEventListener('click', getNewCat);
    document.getElementById('next_fact').addEventListener('click', getNewFact);
...
function getNewCat() {
    ...
    const caption = document.getElementById('name_box');
